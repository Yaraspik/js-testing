...
/* harmony export */   "default": () => (/* binding */ WidgetCardValidator)
/* harmony export */ });
...
/* harmony import */ var _typeCard__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./typeCard */ "./src/js/typeCard.js");
/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./validator */ "./src/js/validator.js");
...
var WidgetCardValidator = /*#__PURE__*/function () {
  function WidgetCardValidator() {
    _classCallCheck(this, WidgetCardValidator);
    this.onSubmit = this.onSubmit.bind(this);
    this.onchange = this.onchange.bind(this);
  }
  _createClass(WidgetCardValidator, [{
    key: "bindToDOM",
    ...
    value: function onSubmit(e) {
      e.preventDefault();
      var cardNumber = this.input.value;
      if (cardNumber.length < 13 || cardNumber.length > 19) {
        this.luhn.textContent = null;
        this.showTooltip(cardNumber.length);
      } else {
        var valid = (0,_validator__WEBPACK_IMPORTED_MODULE_17__["default"])(cardNumber);
        var validText = ' ';
        if (!valid) {
          validText = ' не ';
        }
        this.luhn.textContent = "\u041A\u0430\u0440\u0442\u0430".concat(validText, "\u0432\u0430\u043B\u0438\u0434\u043D\u0430!");
      }
    }
  }, {
    key: "onchange",
    value: function onchange(e) {
      ...
      var systemCard = (0,_typeCard__WEBPACK_IMPORTED_MODULE_16__["default"])(this.input.value);
      var cards = Array.from(this.cards.children);
    ...
    key: "showTooltip",
    value: function showTooltip(length) {
      if (!this.tooltip) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _WidgetCardValidator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WidgetCardValidator */ "./src/js/WidgetCardValidator.js");

var container = document.querySelector('.container');
var cardValidator = new _WidgetCardValidator__WEBPACK_IMPORTED_MODULE_0__["default"]();
cardValidator.bindToDOM(container);

/***/ }),

/***/ "./src/js/definitionPaymentSystem.js":
/*!*******************************************!*\
  !*** ./src/js/definitionPaymentSystem.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (definitionPaymentSystem);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ typeCard)
/* harmony export */ });
...
/* harmony import */ var _definitionPaymentSystem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./definitionPaymentSystem */ "./src/js/definitionPaymentSystem.js");




function typeCard(cardNumber) {
  var activeCard = _definitionPaymentSystem__WEBPACK_IMPORTED_MODULE_3__["default"].find(function (el) {
    return el.number.find(function (element) {
      var strEl = String(element);
